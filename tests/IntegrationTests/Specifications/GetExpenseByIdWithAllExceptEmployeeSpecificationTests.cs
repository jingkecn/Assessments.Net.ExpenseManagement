...
public sealed class GetExpenseByIdWithAllExceptEmployeeSpecificationTests(TestContainerFactory factory)
    : TestBaseWithDbMigration(factory)
{
    [Fact]
    public async Task Should_GetExpenseByIdWithAllExceptEmployee_When_Applied()
    {
        // Arrange
        ...
        var specification = new GetExpenseByIdWithAllExceptEmployeeSpecification(expected.Id);
