...
public sealed class GetExpensesWithAllSpecificationTests(TestContainerFactory factory)
    : TestBaseWithDbMigration(factory)
{
    [Fact]
    public async Task Should_GetExpensesWithAll_When_Applied()
    {
        // Arrange
        ...
        var specification = new GetExpensesWithAllSpecification();
