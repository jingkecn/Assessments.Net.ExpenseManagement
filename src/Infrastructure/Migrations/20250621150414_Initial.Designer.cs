...
namespace Assessments.ExpenseManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250621150414_Initial")]
            ...
            modelBuilder.Entity("Assessments.ExpenseManagement.Domain.Models.Expense", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Amount", "Assessments.ExpenseManagement.Domain.Models.Expense.Amount#Amount", b1 =>
                        {
                            b1.IsRequired();
