...
namespace Assessments.ExpenseManagement.Infrastructure.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "CurrencyCode", "FirstName", "LastName" },
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d"), "EUR", "Jane", "Doe" },
                    { new Guid("d1f8b2c3-4e5f-4a6b-8c9d-0e1f2a3b4c5d"), "CNY", "John", "Doe" }
                });
