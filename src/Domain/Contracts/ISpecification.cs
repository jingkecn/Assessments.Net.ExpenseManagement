...
///     The Specification design pattern eliminates the need for lazy loading in web applications,
...
public interface ISpecification<TEntity> where TEntity : Entity
{
    ...
    Expression<Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>>? OrderBy { get; }
}
